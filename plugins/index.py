...
async def index_files(bot, message):
    ...
    if lock.locked():
        ...
        while True:
            last_msg = await bot.ask(text = "Forward me last message of a channel which I should save to my database.", chat_id = message.from_user.id)
            try:
                ...
                await last_msg.reply_text(f"This Is An Invalid Message.\nError caused Due to <code>{e}</code>")
                continue
